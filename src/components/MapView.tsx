import { AirportEdge, AirportNode, Incident, RouteSummary } from '../types';
...
export function MapView({ nodes, edges, route, corridorFactors, incidents, selectedGate, onGateClick, markerProgress }: Props) {
  ...
  return (
    <section className="mapWrap">
      <svg viewBox="0 0 1024 560" className="mapSvg" role="img" aria-label="Terminal map">
        ...
        <text x="60" y="245" className="mapLabel">Terminal C (Demo Layout)</text>
        ...
        {nodes.filter((node) => node.terminal === 'C').map((node) => {
